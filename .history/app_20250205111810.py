...
def estimations():
    ...
    if request.method == 'POST':
        ...
        suggested_materials = {
            material: round((cost_data["base_price"] * (project_size / 100)), 2)
        ...
        estimated_cost = sum(suggested_materials.values()) + estimated_labor_cost

    return render_template('estimation.html', estimated_cost=estimated_cost, suggested_materials=suggested_materials)
